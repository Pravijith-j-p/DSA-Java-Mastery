...
| Problem                                                   | LeetCode # | Pattern / Key Idea                                | Link                                                                                                                                                     |
| --------------------------------------------------------- | ---------- | ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Binary Tree Maximum Path Sum                              | 124        | DFS + Global Max Path Tracking                    | [Binary Tree Maximum Path Sum](problems/Tree (Advanced & BST)/Binary_Tree_Maximum_Sum_Path.md)                                                           |
| Construct Binary Tree from Preorder and Inorder Traversal | 105        | Recursion + HashMap (Preorder + Inorder Indexing) | [Construct Binary Tree from Preorder and Inorder Traversal](problems/Tree (Advanced & BST)/Construct_Binary_Tree_From_Preorder_and_Inorder_Traversal.md) |
| Design Add and Search Words Data Structure                | 211        | Trie + DFS (Support for '.')                      | [Design Add and Search Words Data Structure](problems/Tree (Advanced & BST)/Design_Add_and_Searchwords_Data_Structure.md)                                |
| Implement Trie (Prefix Tree)                              | 208        | Trie (Prefix Tree Implementation)                 | [Implement Trie (Prefix Tree)](problems/Tree (Advanced & BST)/Implement_Tire(Prefix_Tree).md)                                                            |
| Kth Smallest Element in a BST                             | 230        | Inorder Traversal + Counter                       | [Kth Smallest Element in a BST](problems/Tree (Advanced & BST)/kth_Smallest_Element_in_a_BST.md)                                                         |
| Lowest Common Ancestor of a BST                           | 235        | BST Property + Recursion                          | [Lowest Common Ancestor of a BST](problems/Tree (Advanced & BST)/Lowest_Common_Ancestor_of_a_Binary_Search_Tree.md)                                      |
| Serialize and Deserialize Binary Tree                     | 297        | BFS / DFS Encoding-Decoding                       | [Serialize and Deserialize Binary Tree](problems/Tree (Advanced & BST)/Serialize_and_Deserialise_Binary_Tree.md)                                         |
| Validate Binary Search Tree                               | 98         | Inorder Traversal + Range Validation              | [Validate Binary Search Tree](problems/Tree (Advanced & BST)/Validate_Binary_Search_Tree.md)                                                             |
| Word Search II                                            | 212        | Trie + Backtracking                               | [Word Search II](problems/Tree (Advanced & BST)/Word_Search_II.md)                                                                                       |
